...
export function Question10({ navigation }: QuestionProps) {
  return (
    <Container>
      ...
      <QuestionAnswers>
        <QuestionMain>
          <QuestionText> Que tipo de emoção você quer? </QuestionText>
        </QuestionMain>
        ...
        <Answers>
          <CustomButton
            ...
            onPress={() => navigation.push("Film09")}
          >
            <TextButton color="#FFFFFF"> Alto Astral </TextButton>
          </CustomButton>
          <CustomButton
            backgroundColor="#2ebf91"
            onPress={() => navigation.push("Film10")}
          >
            <TextButton> Desespero </TextButton>
          </CustomButton>
        </Answers>
      </QuestionAnswers>
    </Container>
